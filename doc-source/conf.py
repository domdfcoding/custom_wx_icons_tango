...
github_repository = "custom_wx_icons_tango"
github_url = f"https://github.com/{github_username}/{github_repository}"

rst_prolog = f""".. |pkgname| replace:: wx_icons_tango
.. |pkgname2| replace:: ``wx_icons_tango``
...
html_context = {
		...
		"github_repo": "custom_wx_icons_tango",
